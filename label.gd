...
var lencourage = "You’re a natural! Continue to shelve books until the book cart is empty. Once you’re done with this floor, you may take the elevator to another floor and continue shelving the books on that floor. \n Don’t worry about visiting the basement today, the books that go down there won't be read again."
...
func typeTxt (input_text_array: Array[String]) -> void:
